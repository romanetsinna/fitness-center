...
var _initCoaches = require("./modules/swiper/init-coaches");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  var coaches = document.querySelector('.swiper');
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _initCoaches.initSwiper)(coaches);
  });
});
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/swiper/init-coaches":11,"./modules/tabs/init-tabs":12,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
